...
//银行卡号验证
jQuery.validator.addMethod("bankCardNu", function(value, element) {
	var length = value.length;
...
//验证投资金额必须为100的整数倍
jQuery.validator.addMethod("inversAmt", function(value, element) {
	return this.optional(element) || /^[1-9]\d*00$/.test(value);
}, "投资金额必须为100的整数倍");