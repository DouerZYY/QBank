...
<body class="list">
	...
	<div class="body">
		<form id="listForm" action="admin/dictionary!list.action" method="post">
			<div class="listBar">
				<input type="button" class="formButton" onclick="location.href='admin/dictionary!add.action'" value="添加"/>
				<label>查找:</label>
				<select name="pager.property">
					<option value="dicName">
						名称
					</option>
					<option value="dicCode" >
						编码
					</option>
				</select>
			...
			<table id="listTable" class="listTable">
				...
				<c:forEach items="${pager.list}" var="dictionary" varStatus="vs">  
					<tr>
					<td></td>
						<td>
						${dictionary.dicName}
						...
						<td>
						${dictionary.dictype.dicTypeName}
						</td>
						<td>
						<fmt:formatDate value="${dictionary.createDate }" type="both" dateStyle="long" timeStyle="short"/>	
						</td>
						<td>
							<a href="admin/dictionary!edit.action?id=${dictionary.id}" title="[编辑]">[编辑]</a>
							<a href="admin/dictionary!delete.action?id=${dictionary.id}" title="[删除]">[删除]</a>
						</td>
					</tr>
				</c:forEach>  	
