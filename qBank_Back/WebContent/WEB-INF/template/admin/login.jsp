...
<body class="login">
	...
	<div class="blank"></div>
	<div class="body">
		<form id="loginForm" action="/qbank/admin/login!login2.action" method="post">
            <table class="loginTable">
                ...
                <tr>
                    ...
                    <td>
                    	<input type="password" id="admin.adminPassword" name="admin.adminPassword" class="formText" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="submit" class="homeButton" value=""  hidefocus="true" /><input type="submit" class="submitButton" value="登 录" hidefocus="true" />
                    </td>
                </tr>
            </table>
