...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" action="admin/rates!save.action" method="post">
			<table class="inputTable">
				<tr>
					...
					<td>
						<input type="text" id="rates.rateCode" name="rates.rateCode" class="formText {required: true, min: 0}"/>	 
				...
				<tr>
					...
					<td>
						<input type="text" id="rates.rateAmount" name="rates.rateAmount" class="formText {required: true, min: 0}" />	 
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr>
