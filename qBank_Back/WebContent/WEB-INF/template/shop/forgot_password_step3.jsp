...
<head>
    ...
    <meta name="keywords" content="快借宝，快借宝网站,理财,银行贷款">
    <meta name="description" content="网络银行、在线理财">
    <title>忘记密码Step3</title>
    <!-- Global CSS -->
            ...
            <div class="productDetailpage productDetailpanel">
                ...
                <div class="forgotpassword_step">
                    <div class="forgotpassword_stepT">
                        <ul>
                            ...
                            <li class="forgotpasswordTitleActive"><span class="f24px">3.</span>完成</li>
                        </ul>
                    </div>
                    <div class="forgotpassword_stepB">
                        <ul>
                            ...
                            <li class="forgotpassword_stepB_3">&nbsp;</li>
                        </ul>
                    </div>
                </div>
                <div class="blank30"></div>
                <div class="forgotbox">
                    <div class="left margin10 table-right">
                        <p class="f20px fB"><span class="marginR12"><img src="images/Hook1.png" width="64" height="64" /></span><span>恭喜您，您的密码已更新。</span></p>
                    </div>
                </div>
                <div class="blank40"></div>
                <div class="blank40">
                 	<a href="/qbank/shop/login!index.action" class="btn btn-block btn-cta-primary" style="width:140px;margin:0px auto;">立即登录</a>
                </div>
                <div class="blank40"></div>
            </div>
