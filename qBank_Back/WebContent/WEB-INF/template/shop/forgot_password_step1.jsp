                ...
                <div class="forgotpassword_step">
                    <div class="forgotpassword_stepT">
                        <ul>
                            ...
                            <li class="forgotpasswordSetpTitle"><span class="f24px">2.</span>重置密码</li>
                ...
                <div class="forgotbox">
                    <form>
                        <div class="form-group email">
                            <label class="sr-only f16px" for="login-email">手机号码</label>
                            <span class="form-control-error"></span>
                            <input id="login-email" name="login-email" type="Email" class="form-control login-email-input" style="width:90%" placeholder="手机号码">
                        </div>
                        <!--//form-group-->
                        <div class="form-group password">
                            <label class="sr-only f16px" for="login-password">短信验证码</label>
                            <span class="form-control-error"></span>
                            <div>
                                <input id="login-password" name="login-password" type="password" class="left form-control marginR10" style="width:59%" placeholder="短信验证码">
                                <button type="button" class="left btn btn-cta btn-cta-secondary" data-toggle="modal" data-target="#count-modal">重新发送验证码</button>
                            </div>
                            <div class="blank0"></div>
                        </div>
                        <!--//form-group-->
                        <div class="form-group password">
                            <label class="sr-only f16px" for="login-password">身份证号码</label>
                            <span class="form-control-error"></span>
                            <input id="login-password" name="login-password" type="password" class="form-control login-ID-input" style="width:90%" placeholder="身份证号码">
                        </div>
                        <!--//form-group-->
                        <p class="marginB10">我们将验证码以短信方式发送到您的手机。</p>
                        <a href="/qbank/shop/forgot_password_step2!index.action" class="btn btn-block btn-cta-primary" style="width:372px;">下一步</a>
                    </form>
                </div>
